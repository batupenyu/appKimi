...
const KonversiReport = React.forwardRef<HTMLDivElement, KonversiReportProps>((props, ref) => {
  const {
    nomor = ".........",
    tahun = "TAHUN",
    namaInstansi,
        ...
        <div id="report-content" className="report-content" ref={ref}>
          ...
          <div className="header-center">
            ...
            <div className="font-bold subtitle">
              NOMOR : 800/ {nomor} /.........../Dindik/ {tahun}/PAK
            </div>
          </div>
          ...
          <table className="personal-table">
            ...
            <tbody>
              <PersonalInfoRow number="1." label="Nama" value={pegawai.nama} />
